...
# test:
json_message = json.dumps({"head": ["GET /pagina-ejemplo HTTP/1.1", {"Host": "www.ejemplo.com", "User-Agent": "MiNavegador/1.0", "Accept": "text/html", "Connection": "keep-alive", "Content-Length": "45"}], "body": [{"content": ""}]})
...
parsed = json.loads(parse_HTTP_message(http_message))
print("Content-Length" in parsed["head"][1])
